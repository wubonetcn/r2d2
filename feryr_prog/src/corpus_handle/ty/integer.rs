...
impl IntType {
    ...
    pub fn get_val(&self) -> String {
        match self.pad {
            -8 => return (self.val as i8).to_string(),
            -16 => return (self.val as i16).to_string(),
            -32 => return (self.val as i32).to_string(),
            -64 => return (self.val as i64).to_string(),
            8 => return (self.val as u8).to_string(),
            16 => return (self.val as u16).to_string(),
            32 => return (self.val as u32).to_string(),
            64 => return (self.val as u64).to_string(),
            _ => {
